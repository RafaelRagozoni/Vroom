...
public class ChangeTextureClickManager : MonoBehaviour
{
    ...
    private void HandleClick()
    {
        ...
        if (targetRenderer == null)
            Debug.LogWarning("targetRenderer � NULL! Objeto: " + transform.parent.name);
        if (clickedTargetRenderer == null)
            Debug.LogWarning("clickedTargetRenderer � NULL! Objeto: " + objectClickedTarget.name);
        ...
        {
            Debug.LogWarning("Renderer n�o encontrado em um dos objetos.");
        }
        Debug.Log("Depois");
        InstantiateTexturesUI.Instance.DeactivateTextureEditMode();
    }
