...
namespace Oculus.Interaction
{
    ...
    public class GrabFreeTransformer : MonoBehaviour, ITransformer
    {
        ...
        public void UpdateTransform()
        {
            ...
            SnapGrabableToGrid(targetTransform);

            SnapGrabableToGround(targetTransform);
        }
        ...
        {
            return (float)Math.Floor(v / gridSize) * gridSize;
        }

        private static void SnapGrabableToGround(Transform targetTransform)
        {
