...
namespace Oculus.Interaction
{
    ...
    public class OneGrabTranslateTransformer : MonoBehaviour, ITransformer
    {
        ...
        [Tooltip("Multiplier for how far the object should move relative to hand motion.")]
        public float _movementScale = 1.0f;
        [SerializeField]
        ...
        public void UpdateTransform()
        {
            ...
            Vector3 desiredPosition = result.position;
            Vector3 delta = desiredPosition - originalPosition;

            target.position = originalPosition + delta * _movementScale;
